...
def should_extract_memory(user_text: str, aura_text: str = "", api_key: str = "", aure_text: str = "") -> bool:
    try:
        from or_client import client

        text_ai = aura_text or aure_text
...
def extract_memory(user_text: str, aura_text: str = "", api_key: str = "", aure_text: str = "") -> dict:
    try:
        from or_client import client
        ...
        raw = client.chat(
            ...
            f"                  (e.g. mark_xxv: 'Building a AURA-like AI assistant')\n"
            ...
            f"- Extract from BOTH user and Aura turns.\n"
            ...
            f' "projects":{{"mark_xxv":{{"value":"AURA-like AI assistant"}}}},\n'
