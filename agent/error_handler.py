...
ERROR_ANALYST_PROMPT = """You are the error recovery module of AURA AI assistant.
...
def _call_gemini_error(prompt: str, system_instruction: str = "") -> str:
    ...
    for model_name in ["gemini-3.6-flash", "gemini-2.5-flash", "gemini-2.0-flash"]:
        try:
            ...
            try:
                ...
                model = legacy_genai.GenerativeModel(model_name, system_instruction=system_instruction if system_instruction else None)
...
Attempt number: {attempt}"""
    ...
    try:
        text = _call_gemini_error(prompt, system_instruction=ERROR_ANALYST_PROMPT)
...
Return ONLY the Python code, no explanation."""
    ...
    try:
        code = _call_gemini_error(prompt)
