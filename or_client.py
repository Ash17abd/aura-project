...
class OpenRouterClient:
        ...
        for attempt in range(1, MAX_RETRIES_PER_MODEL + 1):
            try:
                ...
                if resp.status_code in (401, 403):
                    logger.warning(f"[OpenRouter] Authentication failed (HTTP {resp.status_code}). Check your OpenRouter API key.")
                    raise PermissionError(f"OpenRouter authentication failed: HTTP {resp.status_code}")
    ...
    def chat(
        ...
        prompt: str,
        system: str = (
            "You are a component of AURA, an AI assistant. "
